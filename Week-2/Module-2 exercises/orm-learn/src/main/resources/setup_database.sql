-- =============================================================
-- ORM-Learn Full Database Setup Script
-- Creates all tables and seed data for the orm-learn project.
-- Run this in MySQL Workbench or the mysql CLI before starting
-- the application.
-- =============================================================
...
INSERT INTO skill (sk_id, sk_name) VALUES (4, "MySQL");
INSERT INTO skill (sk_id, sk_name) VALUES (5, "Python");

-- -----------------------------------------------------------
-- 4. EMPLOYEE TABLE (FK to department)
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS employee (
    em_id              INT AUTO_INCREMENT PRIMARY KEY,
    em_name            VARCHAR(50)    NOT NULL,
    em_salary          DECIMAL(10,2)  NOT NULL,
    em_date_of_joining DATE           NOT NULL,
    em_dp_id           INT,
...
INSERT INTO employee (em_id, em_name, em_salary, em_date_of_joining, em_dp_id)
VALUES (1, "Rajesh Kumar",    75000.00, "2021-03-15", 1);
INSERT INTO employee (em_id, em_name, em_salary, em_date_of_joining, em_dp_id)
VALUES (2, "Priya Sharma",    82000.00, "2020-07-22", 1);
INSERT INTO employee (em_id, em_name, em_salary, em_date_of_joining, em_dp_id)
VALUES (3, "Anita Desai",     65000.00, "2022-01-10", 2);
INSERT INTO employee (em_id, em_name, em_salary, em_date_of_joining, em_dp_id)
VALUES (4, "Vikram Singh",    90000.00, "2019-11-05", 3);
INSERT INTO employee (em_id, em_name, em_salary, em_date_of_joining, em_dp_id)
VALUES (5, "Sneha Patil",     71000.00, "2023-06-18", 1);

-- -----------------------------------------------------------
-- 5. EMPLOYEE_SKILL JOIN TABLE (many-to-many)
-- -----------------------------------------------------------
